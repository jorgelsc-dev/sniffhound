...
echo "== SniffHound repository visibility checks =="
...
if rg -q "sniffer" README.md && rg -q "sqlite" README.md && rg -q "wsbuilder" README.md; then
  ok "README includes core discoverability keywords"
else
  warn "README is missing one or more core keywords (sniffer, sqlite, wsbuilder)"
fi
